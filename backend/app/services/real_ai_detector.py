...
class RealAIComponentDetector:
    ...
    def detect_components(self, image_path: str, temperature_map: Optional[np.ndarray] = None) -> List[ComponentDetection]:
        """
...
real_ai_detector = RealAIComponentDetector() 